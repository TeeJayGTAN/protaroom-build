...
function Services() {
  ...
  return (
    ...
    <div className="w-full bg-gray-100">
      <div className="services-section mx-auto mt-20 mb-20  overflow-hidden py-6 px-4 font-medium md:max-w-7xl">
        ...
        <div className="cards relative">
          ...
          <div className="arrows absolute top-24 flex w-full justify-between text-5xl">
            <div className="arrow-left absolute -left-4 flex h-14 w-14 items-center justify-center rounded-full bg-white ">
              {' '}
              {'<'}{' '}
            </div>
            <div className="arrow-right absolute -right-4 flex h-14 w-14 items-center justify-center rounded-full bg-white">
              {'>'}
            </div>
          </div>
        </div>
